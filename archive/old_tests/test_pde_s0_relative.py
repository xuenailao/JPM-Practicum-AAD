"""
Test the S0-relative coordinates implementation
"""
...
from aad_edge_pushing.pde.pde_s0_relative import BS_PDE_S0_Relative
...
def main():
    print("="*80)
    print("Test: S0-Relative Coordinates Implementation")
    print("="*80)
    ...
    # PDE with S0-relative
    print(f"\n{'-'*80}")
    print("Computing with S0-Relative Coordinates...")
    print('-'*80)

    solver = BS_PDE_S0_Relative(K=K, T=T, r=r, M=M, N_base=N)
