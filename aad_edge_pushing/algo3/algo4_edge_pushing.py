...
def algo4_edge_pushing(output: ADVar, inputs: List[ADVar]) -> np.ndarray:
    """
...
def _pushing_stage(W: SymmSparse, i: int, preds: List[int],
...
def _creating_stage(W: SymmSparse, preds: List[int],
...
def _extract_input_hessian(W: SymmSparse, input_indices: List[int]) -> np.ndarray:
